            ...
            <section id='sign-up'>
                {!isSubscribed ? (
                    ...
                    <div className="sign-up-border">
                        <div>
                            <img src="/assets/images/illustration-sign-up-mobile.svg" alt="hero" className="hero-image"/>
                        </div>
                    ...
                    <div className="subscribed-wrapper">
                        <div className="success-border">
                            ...
                            <div><button onClick={() => setIsSubscribed(false)} className="button-dismiss">Dismiss message</button></div>
                        </div>
